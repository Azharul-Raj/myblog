...
export const RichTextComponent = {
    ...
    types: {
        ...
        list: {
            ...
            ,
            number: ({ children }: any) =>  (<li className="mt-lg list-decimal">{ children}</li>)
        ...
        block: {
            ...
            ,
            blockquote: ({ children }: any) => ( <blockquote className="border-l-yellow-400 border-l-4 pl-5 py-5 my-5">{ children}</blockquote>)
            ,
        },
        marks: {
